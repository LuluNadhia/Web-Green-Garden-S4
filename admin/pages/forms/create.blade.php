          ...
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="../forms/create.blade.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Ikan</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="../tables/dataIkan.blade.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Data Ikan</p>
                  </a>
                </li>
              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="beratIdeal" id="beratIdeal">
                    <p for="exluasLahan" style="color: grey;">*gram</p>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="jenisAir" id="jenisAir">
                      <option value="1">Tawar</option>
                      <option value="2">Payau</option>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="masaPanen" id="masaPanen">
                      ...
                      <option value="2">3 - 4 bulan</option>
